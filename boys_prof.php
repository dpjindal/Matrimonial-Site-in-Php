...
$sql = "SELECT * FROM profiles INNER JOIN users ON users.id=profiles.user_id WHERE gender= 'M' ORDER BY UploadedOn DESC , profiles.name ";
...
<h2>लड्कोँ के विवाह परिचय पत्रक (नए पत्रक सबसे ऊपर दर्शाए गए हैं</h2><br>
   ...
   <td align="center"><a href="display_prof.php?profId=<?php echo $row['user_id']; ?>" onClick="return confirm('sure to view !'); " class="link"><img src="image/view.jpg" width="40" height="25" alt="Viewe Profile" title='View' hspace='5' /></a>  </td>
